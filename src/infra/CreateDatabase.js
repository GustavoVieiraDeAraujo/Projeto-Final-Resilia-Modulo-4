...
function criaTabelaPlanos() {
  db.run(CreateTablePlans, (error) => {
    if (error) {
      console.log(`Erro ao criar tabela Plans. Erro gerado => ${error.message}`);
      }
    });
  }
...
function criaTabelaUsr() {
  db.run(usersSquema, (error) => {
    if (error) {
      console.log(`Erro ao criar tabela Users. Erro gerado => ${error.message}`)
    }
  })
}
...
function povoaTabelaPlanos() {
  db.run(PopulatingTablePlans, (error) => {
    if (error) {
      console.log(`Erro ao povoar tabela Plans. Erro gerado => ${error.message}`);
    }
  })
}
...
function populaTabelaUsr() {
    db.run(UsersAdd , (error) => {
      if (error) {
      console.log(`Erro ao povoar tabela Users. Erro gerado => ${error.message}`)
    }
  })
}
